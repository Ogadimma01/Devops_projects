...
* Use syntax: $mkdir < directory > to create a new dirctory in the home directory

![image](Images/mkdirh.png)

* To create a new dirrectory in an existing dirctory in the home directory, use syntax: $mkdir <home> <new>
